 ...
 * All rights reserved.                                                        *
 *                                                                             *
 * File:                        BudgetImpactAnalysisReportServlet.java         *
...
import ca.bc.gov.moh.fmdb.business.VBudgetImpactAnalysisFacadeLocal;
 ...
 * @author adam.hoplock
 */
public class BudgetImpactAnalysisReportServlet extends HttpServlet {

    @EJB
    private VBudgetImpactAnalysisFacadeLocal vBudgetImpactAnalysisFacade;
    private static String appName = "Formulary management";
    private static String reportName = "Budget Impact Analysis";
    private static String fileName = "BudgetImpactAnalysisReport.csv";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<VBudgetImpactAnalysis> reportData = vBudgetImpactAnalysisFacade.findReportDataByCriteria(reportView);

            // Write report headers to CSV
            writer.writeAll(buildReportHeader(reportView, reportData.size()));

            // Write data to CSV
            for (VBudgetImpactAnalysis rowData : reportData) {
