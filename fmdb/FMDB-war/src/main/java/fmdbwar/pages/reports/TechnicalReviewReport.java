 ...
 * All rights reserved.                                                        *
 *                                                                             *
 * File:                        TechnicalReviewReport.java                     *
...
/**
 * Backing bean for the Technical Review Report
 */
@Named("TechnicalReviewReport")
@ViewScoped
public class TechnicalReviewReport implements Serializable {

    private String reportView = null; // reportView value from the JSP
    private SelectItem[] reportViewOptions = null; // reportView options used by the drop down

    /** Creates a new instance of TechnicalReviewReport */
    public TechnicalReviewReport() {
    }
