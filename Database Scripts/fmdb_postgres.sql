...
ON :db_name.person_pwn;

-- ------------ Write DROP-FUNCTION-stage scripts -----------

DROP ROUTINE IF EXISTS :db_name.fmdb_microstrategy$businessdaysbetween(IN TIMESTAMP WITHOUT TIME ZONE, IN TIMESTAMP WITHOUT TIME ZONE);

DROP ROUTINE IF EXISTS :db_name.person_pwn_pk_trg$person_pwn();

-- ------------ Write DROP-FOREIGN-KEY-CONSTRAINT-stage scripts -----------

ALTER TABLE :db_name.fmdb_addresses DROP CONSTRAINT adr_adrt_fk;

ALTER TABLE :db_name.fmdb_addresses DROP CONSTRAINT adr_cn_fk;

ALTER TABLE :db_name.fmdb_addresses DROP CONSTRAINT adr_com_fk;

ALTER TABLE :db_name.fmdb_addresses DROP CONSTRAINT adr_reg_fk;

ALTER TABLE :db_name.fmdb_chemicals DROP CONSTRAINT che_sub_fk;

ALTER TABLE :db_name.fmdb_companies DROP CONSTRAINT com_ct1_fk;

ALTER TABLE :db_name.fmdb_contact_details DROP CONSTRAINT cd_cn_fk;

ALTER TABLE :db_name.fmdb_contact_details DROP CONSTRAINT cd_com_fk;

ALTER TABLE :db_name.fmdb_contact_names DROP CONSTRAINT cn_com_fk;

ALTER TABLE :db_name.fmdb_contact_names DROP CONSTRAINT cn_ct_fk;

ALTER TABLE :db_name.fmdb_dins DROP CONSTRAINT din_che_fk;

ALTER TABLE :db_name.fmdb_economic_statuses DROP CONSTRAINT es_sub_fk;

ALTER TABLE :db_name.fmdb_pla_logs DROP CONSTRAINT pl_pla_fk;

ALTER TABLE :db_name.fmdb_product_listing_agreement DROP CONSTRAINT pla_pst_fk;

ALTER TABLE :db_name.fmdb_product_listing_agreement DROP CONSTRAINT pla_sub_fk;

ALTER TABLE :db_name.fmdb_regions DROP CONSTRAINT reg_ctry_fk;

ALTER TABLE :db_name.fmdb_review_questions DROP CONSTRAINT rq_rnt_fk;

ALTER TABLE :db_name.fmdb_review_questions DROP CONSTRAINT rq_srd_fk;

ALTER TABLE :db_name.fmdb_submission DROP CONSTRAINT sub_cn_fk;

ALTER TABLE :db_name.fmdb_submission DROP CONSTRAINT sub_com_fk;

ALTER TABLE :db_name.fmdb_submission DROP CONSTRAINT sub_st_fk;

ALTER TABLE :db_name.fmdb_submission_review_details DROP CONSTRAINT srd_brc_fk;

ALTER TABLE :db_name.fmdb_submission_review_details DROP CONSTRAINT srd_rs_fk;

ALTER TABLE :db_name.fmdb_submission_review_details DROP CONSTRAINT srd_sub_fk;

-- ------------ Write DROP-CONSTRAINT-stage scripts -----------

ALTER TABLE :db_name.databasechangeloglock DROP CONSTRAINT pk_databasechangeloglock;

ALTER TABLE :db_name.fmdb_address_types DROP CONSTRAINT adrt_pk;

ALTER TABLE :db_name.fmdb_address_types DROP CONSTRAINT avcon_1202340926_activ_005;

ALTER TABLE :db_name.fmdb_addresses DROP CONSTRAINT adr_pk;

ALTER TABLE :db_name.fmdb_bia_requested_codes DROP CONSTRAINT avcon_1202340926_activ_006;

ALTER TABLE :db_name.fmdb_bia_requested_codes DROP CONSTRAINT brc_pk;

ALTER TABLE :db_name.fmdb_chemicals DROP CONSTRAINT che_pk;

ALTER TABLE :db_name.fmdb_chemicals DROP CONSTRAINT che_sub_uniq;

ALTER TABLE :db_name.fmdb_companies DROP CONSTRAINT com_pk;

ALTER TABLE :db_name.fmdb_company_types DROP CONSTRAINT avcon_1202340926_activ_001;

ALTER TABLE :db_name.fmdb_company_types DROP CONSTRAINT ct1_pk;

ALTER TABLE :db_name.fmdb_contact_details DROP CONSTRAINT cd_pk;

ALTER TABLE :db_name.fmdb_contact_names DROP CONSTRAINT cn_pk;

ALTER TABLE :db_name.fmdb_contact_types DROP CONSTRAINT avcon_1202340926_activ_008;

ALTER TABLE :db_name.fmdb_contact_types DROP CONSTRAINT ct_pk;

ALTER TABLE :db_name.fmdb_countries DROP CONSTRAINT avcon_1202340926_activ_003;

ALTER TABLE :db_name.fmdb_countries DROP CONSTRAINT ctry_pk;

ALTER TABLE :db_name.fmdb_dins DROP CONSTRAINT din_pk;

ALTER TABLE :db_name.fmdb_economic_statuses DROP CONSTRAINT es_pk;

ALTER TABLE :db_name.fmdb_pla_logs DROP CONSTRAINT pl_pk;

ALTER TABLE :db_name.fmdb_pla_status_types DROP CONSTRAINT avcon_1202340926_activ_002;

ALTER TABLE :db_name.fmdb_pla_status_types DROP CONSTRAINT pst_pk;

ALTER TABLE :db_name.fmdb_product_listing_agreement DROP CONSTRAINT pla_pk;

ALTER TABLE :db_name.fmdb_regions DROP CONSTRAINT avcon_1202340926_activ_004;

ALTER TABLE :db_name.fmdb_regions DROP CONSTRAINT reg_pk;

ALTER TABLE :db_name.fmdb_review_questions DROP CONSTRAINT avcon_1202340926_psd_r_000;

ALTER TABLE :db_name.fmdb_review_questions DROP CONSTRAINT rq_pk;

ALTER TABLE :db_name.fmdb_review_statuses DROP CONSTRAINT rs_pk;

ALTER TABLE :db_name.fmdb_reviewer_name_types DROP CONSTRAINT avcon_1202340926_activ_007;

ALTER TABLE :db_name.fmdb_reviewer_name_types DROP CONSTRAINT rnt_pk;

ALTER TABLE :db_name.fmdb_submission DROP CONSTRAINT avcon_1202340926_post_000;

ALTER TABLE :db_name.fmdb_submission DROP CONSTRAINT sub_pk;

ALTER TABLE :db_name.fmdb_submission DROP CONSTRAINT sub_submission_no_uk;

ALTER TABLE :db_name.fmdb_submission_review_details DROP CONSTRAINT avcon_1202340926_cdr_r_000;

ALTER TABLE :db_name.fmdb_submission_review_details DROP CONSTRAINT avcon_1202340926_lette_000;

ALTER TABLE :db_name.fmdb_submission_review_details DROP CONSTRAINT avcon_1202340926_sa_re_000;

ALTER TABLE :db_name.fmdb_submission_review_details DROP CONSTRAINT srd_pk;

ALTER TABLE :db_name.fmdb_submission_types DROP CONSTRAINT avcon_1202340926_activ_000;

ALTER TABLE :db_name.fmdb_submission_types DROP CONSTRAINT st_pk;

ALTER TABLE :db_name.person_pwn DROP CONSTRAINT person_pwn_pk;

-- ------------ Write DROP-INDEX-stage scripts -----------

DROP INDEX IF EXISTS :db_name.adr_adrt_fk_i;

DROP INDEX IF EXISTS :db_name.adr_cn_fk_i;

DROP INDEX IF EXISTS :db_name.adr_com_fk_i;

DROP INDEX IF EXISTS :db_name.adr_reg_fk_i;

DROP INDEX IF EXISTS :db_name.com_ct1_fk_i;

DROP INDEX IF EXISTS :db_name.cd_cn_fk_i;

DROP INDEX IF EXISTS :db_name.cd_com_fk_i;

DROP INDEX IF EXISTS :db_name.cn_com_fk_i;

DROP INDEX IF EXISTS :db_name.cn_ct_fk_i;

DROP INDEX IF EXISTS :db_name.din_che_fk_i;

DROP INDEX IF EXISTS :db_name.es_sub_fk_i;

DROP INDEX IF EXISTS :db_name.pl_pla_fk_i;

DROP INDEX IF EXISTS :db_name.pla_pst_fk_i;

DROP INDEX IF EXISTS :db_name.pla_sub_fk_i;

DROP INDEX IF EXISTS :db_name.reg_ctry_fk_i;

DROP INDEX IF EXISTS :db_name.rq_rnt_fk_i;

DROP INDEX IF EXISTS :db_name.rq_srd_fk_i;

DROP INDEX IF EXISTS :db_name.sub_com_fk_i;

DROP INDEX IF EXISTS :db_name.sub_st_fk_i;

DROP INDEX IF EXISTS :db_name.srd_brc_fk_i;

DROP INDEX IF EXISTS :db_name.srd_rs_fk_i;

DROP INDEX IF EXISTS :db_name.srd_sub_fk_i;

-- ------------ Write DROP-VIEW-stage scripts -----------

DROP VIEW IF EXISTS :db_name.fmdb_budget_impact_analysis_vw;

DROP VIEW IF EXISTS :db_name.fmdb_drug_benefit_committee_vw;

DROP VIEW IF EXISTS :db_name.fmdb_public_access_vw;

DROP VIEW IF EXISTS :db_name.fmdb_single_drug_sub_status_vw;

DROP VIEW IF EXISTS :db_name.fmdb_special_auth_forms_vw;

DROP VIEW IF EXISTS :db_name.fmdb_subm_by_applicant_vw;

DROP VIEW IF EXISTS :db_name.fmdb_submissions_vw;

DROP VIEW IF EXISTS :db_name.fmdb_technical_review_vw;

-- ------------ Write DROP-TABLE-stage scripts -----------

DROP TABLE IF EXISTS :db_name.databasechangeloglock;

DROP TABLE IF EXISTS :db_name.fmdb_address_types;

DROP TABLE IF EXISTS :db_name.fmdb_addresses;

DROP TABLE IF EXISTS :db_name.fmdb_bia_requested_codes;

DROP TABLE IF EXISTS :db_name.fmdb_chemicals;

DROP TABLE IF EXISTS :db_name.fmdb_companies;

DROP TABLE IF EXISTS :db_name.fmdb_company_types;

DROP TABLE IF EXISTS :db_name.fmdb_contact_details;

DROP TABLE IF EXISTS :db_name.fmdb_contact_names;

DROP TABLE IF EXISTS :db_name.fmdb_contact_types;

DROP TABLE IF EXISTS :db_name.fmdb_countries;

DROP TABLE IF EXISTS :db_name.fmdb_dins;

DROP TABLE IF EXISTS :db_name.fmdb_economic_statuses;

DROP TABLE IF EXISTS :db_name.fmdb_pla_logs;

DROP TABLE IF EXISTS :db_name.fmdb_pla_status_types;

DROP TABLE IF EXISTS :db_name.fmdb_product_listing_agreement;

DROP TABLE IF EXISTS :db_name.fmdb_regions;

DROP TABLE IF EXISTS :db_name.fmdb_review_questions;

DROP TABLE IF EXISTS :db_name.fmdb_review_statuses;

DROP TABLE IF EXISTS :db_name.fmdb_reviewer_name_types;

DROP TABLE IF EXISTS :db_name.fmdb_submission;

DROP TABLE IF EXISTS :db_name.fmdb_submission_review_details;

DROP TABLE IF EXISTS :db_name.fmdb_submission_types;

DROP TABLE IF EXISTS :db_name.person_pwn;

-- ------------ Write DROP-SEQUENCE-stage scripts -----------

DROP SEQUENCE IF EXISTS :db_name.fmdb_adr_seq;

DROP SEQUENCE IF EXISTS :db_name.fmdb_cd_seq;

DROP SEQUENCE IF EXISTS :db_name.fmdb_che_seq;

DROP SEQUENCE IF EXISTS :db_name.fmdb_cn_seq;

DROP SEQUENCE IF EXISTS :db_name.fmdb_com_seq;

DROP SEQUENCE IF EXISTS :db_name.fmdb_din_seq;

DROP SEQUENCE IF EXISTS :db_name.fmdb_es_seq;

DROP SEQUENCE IF EXISTS :db_name.fmdb_pl_seq;

DROP SEQUENCE IF EXISTS :db_name.fmdb_pla_seq;

DROP SEQUENCE IF EXISTS :db_name.fmdb_rq_seq;

DROP SEQUENCE IF EXISTS :db_name.fmdb_srd_seq;

DROP SEQUENCE IF EXISTS :db_name.fmdb_sub_seq;

DROP SEQUENCE IF EXISTS :db_name.person_pwn_pk_seq;
...
CREATE SEQUENCE IF NOT EXISTS :db_name.fmdb_adr_seq
INCREMENT BY 1
START WITH 911
...
CREATE SEQUENCE IF NOT EXISTS :db_name.fmdb_cd_seq
INCREMENT BY 1
START WITH 961
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS :db_name.fmdb_che_seq
INCREMENT BY 1
START WITH 11654
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS :db_name.fmdb_cn_seq
INCREMENT BY 1
START WITH 703
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS :db_name.fmdb_com_seq
INCREMENT BY 1
START WITH 594
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS :db_name.fmdb_din_seq
INCREMENT BY 1
START WITH 2071
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS :db_name.fmdb_es_seq
INCREMENT BY 1
START WITH 1975
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS :db_name.fmdb_pl_seq
INCREMENT BY 1
START WITH 219
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS :db_name.fmdb_pla_seq
INCREMENT BY 1
START WITH 856
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS :db_name.fmdb_rq_seq
INCREMENT BY 1
START WITH 361
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS :db_name.fmdb_srd_seq
INCREMENT BY 1
START WITH 1619
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS :db_name.fmdb_sub_seq
INCREMENT BY 1
START WITH 11702
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE SEQUENCE IF NOT EXISTS :db_name.person_pwn_pk_seq
INCREMENT BY 1
START WITH 19
MAXVALUE 9223372036854775807
MINVALUE 1
...
CREATE TABLE :db_name.databasechangeloglock(
...
CREATE TABLE :db_name.fmdb_address_types(
...
CREATE TABLE :db_name.fmdb_addresses(
...
COMMENT ON COLUMN :db_name.fmdb_addresses.address_first_line_txt
     IS 'the first line of an address';
COMMENT ON COLUMN :db_name.fmdb_addresses.address_second_line_txt
     IS 'the second line of an address';
COMMENT ON COLUMN :db_name.fmdb_addresses.postal_code_txt
     IS 'contains zip code or canadian postal code';
COMMENT ON COLUMN :db_name.fmdb_addresses.city_nm
     IS 'the  name of the city';
COMMENT ON COLUMN :db_name.fmdb_addresses.contact_name_id
     IS 'a unique system generated ID';

CREATE TABLE :db_name.fmdb_bia_requested_codes(
...
CREATE TABLE :db_name.fmdb_chemicals(
...
COMMENT ON COLUMN :db_name.fmdb_chemicals.chemical_nm
     IS 'the chemical or generic name of the drug(s) Chemical name, a long example, 61 characters:';
COMMENT ON COLUMN :db_name.fmdb_chemicals.medical_indications_txt
...
COMMENT ON COLUMN :db_name.fmdb_chemicals.market_release_dt
     IS 'the date the drug was released on the market.';
COMMENT ON COLUMN :db_name.fmdb_chemicals.noc_dt
     IS 'The date health Canada issued notice of compliance approval.';
COMMENT ON COLUMN :db_name.fmdb_chemicals.patent_expiry_dt
     IS 'The date the Patent expires on a brand  name drug.';
COMMENT ON COLUMN :db_name.fmdb_chemicals.trade_nm
     IS 'the trade or brand name of the drug(s)';
COMMENT ON COLUMN :db_name.fmdb_chemicals.submission_id
     IS 'A system generated unique identifier for a submission number';

CREATE TABLE :db_name.fmdb_companies(
...
COMMENT ON COLUMN :db_name.fmdb_companies.legal_nm
     IS 'The legal name of a  company or companies';
COMMENT ON COLUMN :db_name.fmdb_companies.alias_nm
     IS 'Also Known as name or alias';
COMMENT ON COLUMN :db_name.fmdb_companies.expiry_dt
     IS 'When the company expires, which could be caused by mergers , acquisitions and or bankrupt, or some other business failure.';
COMMENT ON COLUMN :db_name.fmdb_companies.expiry_reason_dsc
     IS 'The reason for the termination.';
COMMENT ON COLUMN :db_name.fmdb_companies.start_dt
     IS 'the date Moh enters the company into the database.';
COMMENT ON COLUMN :db_name.fmdb_companies.created_on_dtm
     IS 'date recorded created or entered';
COMMENT ON COLUMN :db_name.fmdb_companies.created_by_nm
     IS 'the userid who created or entered the record';
COMMENT ON COLUMN :db_name.fmdb_companies.last_modified_dtm
     IS 'the date the record was updated.';
COMMENT ON COLUMN :db_name.fmdb_companies.last_modified_by_nm
     IS 'the userid who updated the record.';
COMMENT ON COLUMN :db_name.fmdb_companies.company_type_cd
     IS 'the code for the description';

CREATE TABLE :db_name.fmdb_company_types(
    company_type_cd CHARACTER VARYING(15) NOT NULL,
...
COMMENT ON COLUMN :db_name.fmdb_company_types.company_type_cd
     IS 'the code for the description';
COMMENT ON COLUMN :db_name.fmdb_company_types.company_type_dsc
     IS 'the full description of the code';
COMMENT ON COLUMN :db_name.fmdb_company_types.created_on_dtm
     IS 'Identifies when the information was created.';
COMMENT ON COLUMN :db_name.fmdb_company_types.created_by_nm
     IS 'Identifies the userid or who created the information.';
COMMENT ON COLUMN :db_name.fmdb_company_types.last_modified_dtm
     IS 'the date the record was updated.';
COMMENT ON COLUMN :db_name.fmdb_company_types.last_modified_by_nm
     IS 'the user who updated the record.';

CREATE TABLE :db_name.fmdb_contact_details(
...
COMMENT ON COLUMN :db_name.fmdb_contact_details.contact_dtl_id
     IS 'a unique system generated ID';
COMMENT ON COLUMN :db_name.fmdb_contact_details.cell_no
     IS 'cell phone number';
COMMENT ON COLUMN :db_name.fmdb_contact_details.email_address
     IS 'email address of contact';
COMMENT ON COLUMN :db_name.fmdb_contact_details.fax_no
     IS 'fax number at work.';
COMMENT ON COLUMN :db_name.fmdb_contact_details.work_phone_no
     IS 'work phone number + area code';
COMMENT ON COLUMN :db_name.fmdb_contact_details.work_ph_ext_no
     IS 'extension number at work';
COMMENT ON COLUMN :db_name.fmdb_contact_details.contact_name_id
     IS 'a unique system generated ID';

CREATE TABLE :db_name.fmdb_contact_names(
...
COMMENT ON COLUMN :db_name.fmdb_contact_names.contact_name_id
     IS 'a unique system generated ID';
COMMENT ON COLUMN :db_name.fmdb_contact_names.first_nm
     IS 'first name of person';
COMMENT ON COLUMN :db_name.fmdb_contact_names.last_nm
     IS 'Last Name';
COMMENT ON COLUMN :db_name.fmdb_contact_names.job_title_nm
     IS 'the official position of the person';
COMMENT ON COLUMN :db_name.fmdb_contact_names.effective_dt
     IS 'The date the Ministry of Health is aware of the contact';
COMMENT ON COLUMN :db_name.fmdb_contact_names.expiry_dt
     IS 'contact no longer exists';

CREATE TABLE :db_name.fmdb_contact_types(
    contact_type_cd CHARACTER VARYING(15) NOT NULL,
...
COMMENT ON COLUMN :db_name.fmdb_contact_types.active_yn
     IS ' YN';

CREATE TABLE :db_name.fmdb_countries(
...
CREATE TABLE :db_name.fmdb_dins(
...
COMMENT ON COLUMN :db_name.fmdb_dins.din_id
     IS 'A unique identifier for DIN';
COMMENT ON COLUMN :db_name.fmdb_dins.din_no
...
COMMENT ON COLUMN :db_name.fmdb_dins.dosage_form_txt
     IS 'the quantity and how the drug is administered.';
COMMENT ON COLUMN :db_name.fmdb_dins.created_by_nm
     IS 'The userid of who created the information.';
COMMENT ON COLUMN :db_name.fmdb_dins.created_oin_dtm
     IS 'the date and time of when the information was created .';
COMMENT ON COLUMN :db_name.fmdb_dins.last_modified_by_nm
     IS 'The userid of who modified the information.';
COMMENT ON COLUMN :db_name.fmdb_dins.lasted_modfied_dtm
     IS 'The date and time of when the information was modified.';

CREATE TABLE :db_name.fmdb_economic_statuses(
...
COMMENT ON COLUMN :db_name.fmdb_economic_statuses.economic_id
     IS 'Unique key. Generated from sequence';
COMMENT ON COLUMN :db_name.fmdb_economic_statuses.relative_year_no
     IS 'The year  the PSD is tracking the information. Values could be  -1 -2 -3 or +1 +2 +3.';
COMMENT ON COLUMN :db_name.fmdb_economic_statuses.psd_patient_actuals_qty
     IS 'the number of PSD beneficiaries for the drug.';
COMMENT ON COLUMN :db_name.fmdb_economic_statuses.psd_expenditure_amt
     IS 'the dollar amount  spent by PSD on the drug, expressed to 3 decimal places.';
COMMENT ON COLUMN :db_name.fmdb_economic_statuses.psd_prediction_amt
     IS 'the dollar amount predicted by  PSD , expressed to 3 decimal places.';
COMMENT ON COLUMN :db_name.fmdb_economic_statuses.bc_actual_amt
     IS 'the amount spent in bc on the drug, expressed to 3 decimal places.';
COMMENT ON COLUMN :db_name.fmdb_economic_statuses.analysis_notes
     IS 'any notes relevant to the economic part of the drug.';
COMMENT ON COLUMN :db_name.fmdb_economic_statuses.bc_num_patient_actuals_qty
     IS 'number of patients who  received the drug in BC; the number patients that purchased the drug in BC.';
COMMENT ON COLUMN :db_name.fmdb_economic_statuses.company_prediction_amt
     IS 'the dollar amount predicted by the company , expressed to 3 decimal places.';
COMMENT ON COLUMN :db_name.fmdb_economic_statuses.submission_id
     IS 'A system generated unique identifier for a submission number';

CREATE TABLE :db_name.fmdb_pla_logs(
...
COMMENT ON COLUMN :db_name.fmdb_pla_logs.pla_log_id
     IS 'A unique identifier for the PLA log';
COMMENT ON COLUMN :db_name.fmdb_pla_logs.activity_details_txt
     IS 'The activity that was completed refering to a PLA';
COMMENT ON COLUMN :db_name.fmdb_pla_logs.activity_dt
     IS 'The date of a PLA activity completed';
COMMENT ON COLUMN :db_name.fmdb_pla_logs.pla_id
     IS 'A unique identifier for the PLA. generated from sequence';

CREATE TABLE :db_name.fmdb_pla_status_types(
...
CREATE TABLE :db_name.fmdb_product_listing_agreement(
    pla_id NUMERIC(15,0) NOT NULL,
    effective_dt TIMESTAMP(0) WITHOUT TIME ZONE,
    expiry_dt TIMESTAMP(0) WITHOUT TIME ZONE,
...
COMMENT ON COLUMN :db_name.fmdb_product_listing_agreement.pla_id
     IS 'A unique identifier for the PLA. generated from sequence';
COMMENT ON COLUMN :db_name.fmdb_product_listing_agreement.effective_dt
     IS 'The date the PLA became effective for the company';
COMMENT ON COLUMN :db_name.fmdb_product_listing_agreement.expiry_dt
     IS 'The date the PLA expired for the company- no longer applicable.';
COMMENT ON COLUMN :db_name.fmdb_product_listing_agreement.comments_txt
     IS 'Comments about the PLA';
COMMENT ON COLUMN :db_name.fmdb_product_listing_agreement.created_on_dtm
     IS 'Identifies when the information was created.';
COMMENT ON COLUMN :db_name.fmdb_product_listing_agreement.created_by_nm
     IS 'Identifies the userid or who created the information.';
COMMENT ON COLUMN :db_name.fmdb_product_listing_agreement.last_modified_dtm
     IS 'Identifies when the information was modified.';
COMMENT ON COLUMN :db_name.fmdb_product_listing_agreement.last_modified_by_nm
     IS 'Identifies the userid or who modified the information.';
COMMENT ON COLUMN :db_name.fmdb_product_listing_agreement.submission_id
     IS 'A system generated unique identifier for a submission number';

CREATE TABLE :db_name.fmdb_regions(
...
CREATE TABLE :db_name.fmdb_review_questions(
...
COMMENT ON COLUMN :db_name.fmdb_review_questions.review_question_id
     IS 'Unique key';
COMMENT ON COLUMN :db_name.fmdb_review_questions.question_txt
...
COMMENT ON COLUMN :db_name.fmdb_review_questions.conclusion
     IS 'The conclusion the reviewer reached. "Conclusions, example 1, 1333 characters:
Conclusions, example 2, 734 characters:"';
COMMENT ON COLUMN :db_name.fmdb_review_questions.question_sent_dt
     IS 'The date the question was sent to the reviewer';
COMMENT ON COLUMN :db_name.fmdb_review_questions.target_completion_dt
     IS 'The date PSD expects a conclusion from the reviewer.';
COMMENT ON COLUMN :db_name.fmdb_review_questions.psd_requested_yn
...
COMMENT ON COLUMN :db_name.fmdb_review_questions.actual_completion_dt
     IS 'The date PSD received a conclusion.';
COMMENT ON COLUMN :db_name.fmdb_review_questions.submission_review_id
     IS 'Surrogate key - system generated.';

CREATE TABLE :db_name.fmdb_review_statuses(
...
COMMENT ON COLUMN :db_name.fmdb_review_statuses.review_status_cd
     IS 'Values:Under review, Pending, Complete';

CREATE TABLE :db_name.fmdb_reviewer_name_types(
...
CREATE TABLE :db_name.fmdb_submission(
    submission_id NUMERIC(15,0) NOT NULL,
...
COMMENT ON COLUMN :db_name.fmdb_submission.submission_id
     IS 'A system generated unique identifier for a submission number';
COMMENT ON COLUMN :db_name.fmdb_submission.submission_no
...
COMMENT ON COLUMN :db_name.fmdb_submission.received_dt
     IS 'the date the submission was received';
COMMENT ON COLUMN :db_name.fmdb_submission.psd_web_comments
     IS 'This a Y/N  indicator that the submission information should be posted to the public web site';
COMMENT ON COLUMN :db_name.fmdb_submission.post_submission_to_web_yn
...
';
COMMENT ON COLUMN :db_name.fmdb_submission.xref_number_txt
     IS 'This a prev submission number the current application is related to.';

CREATE TABLE :db_name.fmdb_submission_review_details(
    submission_review_id NUMERIC(15,0) NOT NULL,
...
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.submission_review_id
     IS 'Surrogate key - system generated.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.bia_actual_dt
     IS 'The Actual completion date for the BIA.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.bia_assigned_to_nm
     IS 'the  person/staff in the BIA group assigned to the request';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.bia_notes_txt
     IS 'Miscellaneous notes entered by the PSD staff about the request.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.bia_requested_dt
     IS 'The date the Budget Impact Analysis was requested';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.bia_target_dt
     IS 'The target completion date for the BIA.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.bia_requested_by_nm
     IS 'the name of the person  who requested the BIA';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.briefing_note_signed_dt
     IS 'The date the Briefing Note was signed by Executive Director or ADM or some other authority.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.cdr_initiate_dt
     IS 'The date the  CDR initiated a review of the submission.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.cdr_review_yn
     IS 'Is the CDR reviewing this drug.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.dbc_actual_dt
     IS 'The actual meeting date for the DBC.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.dbc_notes_txt
     IS 'PSD notes about issues around the drug benefit committee';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.dbc_recommendation_finalized_d
     IS 'The date  the dbc recommendation is finalized.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.dbc_recommendation_notes_txt
     IS 'DBC recommendation to PSD about the submission.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.dbc_target_dt
     IS 'The target meeting date for the Drug benefit committee(DBC)';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.dbr_initiated_dt
     IS 'The date the DBR was sent to HIBC to be entered into PharmaNet.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.dbr_pharmanet_dt
     IS 'The Pharmanet effective date .Typically up to 10 days after the DBR initiated date.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.sa_completed_dt
     IS 'The date the SA forms were completed by Forms Management group.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.sa_initiated_dt
     IS 'The date SA forms were requested';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.sa_notes_txt
     IS 'This issues about the SA forms';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.sa_required_yn
     IS 'An indicator to determine if the Special Authority forms are  required.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.sa_target_dt
     IS 'The date you expect the SA forms to be completed by Forms Management group.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.cedac_comments_txt
     IS 'PSD comments about the CEDAC review';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.cedac_meet_actual_dt
     IS 'The date the CEDAC meeting occurred.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.cedac_meet_target_dt
     IS 'The target date for CEDAC to review the submission.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.cedac_recommendation_dt
     IS 'The date CEDAC issued a recommendation.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.cedac_recommendation_txt
...
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.company_notice_sent_dt
     IS 'Letter sent to the company indicating the review is closed';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.letter_bin
     IS 'PDF copy  of the Drug Benefit Committee Recommendation and PSD listing decision';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.letter_image_public_yn
     IS 'An indicator that this letter can be published to the public web site.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.submission_id
     IS 'A system generated unique identifier for a submission number';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.review_status_cd
     IS 'values:Under review, Pending, Complete';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.contact_name_comments_txt
     IS 'general comments regard the submission contact.';
COMMENT ON COLUMN :db_name.fmdb_submission_review_details.view_dbc_actual_date_yn
     IS 'determine whether or not to make the acutal date field veiwable on the public site';

CREATE TABLE :db_name.fmdb_submission_types(
    submission_type_cd CHARACTER VARYING(15) NOT NULL,
...
CREATE TABLE :db_name.person_pwn(
...
CREATE OR REPLACE  VIEW :db_name.fmdb_budget_impact_analysis_vw (submission_no, chemical_name, applicant, indication, sub_type, cdr, bia_requested_name, bia_assigned_name, bia_requested_date, bia_target_date, bia_actual_date, bia_days, bia_notes, psd_status, bia_desc, rn) AS
SELECT
    ...
    FROM :db_name.fmdb_submission AS sub, :db_name.fmdb_submission_types AS sut, :db_name.fmdb_companies AS co, :db_name.fmdb_chemicals AS ch, :db_name.fmdb_review_statuses AS rs, :db_name.fmdb_submission_review_details AS srd, :db_name.fmdb_bia_requested_codes AS brc
...
CREATE OR REPLACE  VIEW :db_name.fmdb_drug_benefit_committee_vw (submission_no, chemical_name, applicant, indication, sub_type, cdr, date_review_start, dateofcdr_recommendation, cdr_recommendation, dbc_target_date, dbc_actual_date, dbcrec_finalized_date, dbc_days, dbcrec_notes, dbc_notes, psd_status, rn) AS
SELECT
    sub.submission_no AS submission_no, CONCAT_WS('', ch.chemical_nm,
    CASE
        WHEN ch.trade_nm IS NULL THEN NULL
    ...
    FROM :db_name.fmdb_submission AS sub, :db_name.fmdb_submission_types AS sut, :db_name.fmdb_companies AS co, :db_name.fmdb_chemicals AS ch, :db_name.fmdb_review_statuses AS rs, :db_name.fmdb_submission_review_details AS srd
...
SELECT
    ...
    FROM :db_name.fmdb_chemicals AS c, :db_name.fmdb_submission_types AS st, :db_name.fmdb_review_statuses AS rs, :db_name.fmdb_submission_review_details AS rd
    LEFT OUTER JOIN (SELECT
        rd2.letter_bin, rd2.submission_review_id
        FROM :db_name.fmdb_submission_review_details AS rd2
        WHERE rd2.letter_image_public_yn = 'Y') AS l
        ON (l.submission_review_id = rd.submission_review_id), :db_name.fmdb_submission AS s
    LEFT OUTER JOIN :db_name.fmdb_companies AS cp
...
SELECT
    ...
    (SELECT
        submission_type_dsc
        FROM :db_name.fmdb_submission_types AS st
        ...
        review_status_dsc
        FROM :db_name.fmdb_review_statuses AS rs
    ...
    (SELECT
        bia_requested_dsc
        FROM :db_name.fmdb_bia_requested_codes AS brc
    ...
    /* Address for Contact */
    :db_name.fmdb_chemicals AS ch
    LEFT OUTER JOIN :db_name.fmdb_submission AS s
        ON (ch.submission_id = s.submission_id)
    LEFT OUTER JOIN :db_name.fmdb_companies AS co
        ON (s.company_id = co.company_id)
    LEFT OUTER JOIN :db_name.fmdb_addresses AS addr_co
        ON (s.company_id = addr_co.company_id)
    LEFT OUTER JOIN :db_name.fmdb_contact_details AS applicant
        ON (s.company_id = applicant.company_id)
    LEFT OUTER JOIN :db_name.fmdb_contact_names AS cn
        ON (s.contact_name_id = cn.contact_name_id)
    LEFT OUTER JOIN :db_name.fmdb_addresses AS addr_cn
        ON (s.contact_name_id = addr_cn.contact_name_id)
    LEFT OUTER JOIN :db_name.fmdb_contact_details AS contact
        ON (s.contact_name_id = contact.contact_name_id)
    LEFT OUTER JOIN :db_name.fmdb_submission_review_details AS srd
        ON (ch.submission_id = srd.submission_id)
    LEFT OUTER JOIN :db_name.fmdb_product_listing_agreement AS pla
        ON (ch.submission_id = pla.submission_id)
    WHERE applicant.contact_name_id IS NULL;

CREATE OR REPLACE  VIEW :db_name.fmdb_special_auth_forms_vw (submission_no, chemical_name, applicant, indication, sub_type, cdr, sa_initiated_date, sa_target_date, sa_completed_date, sa_days, sa_notes, psd_status, sa_required_yn, rn) AS
SELECT
    sub.submission_no AS submission_no, CONCAT_WS('', ch.chemical_nm,
    CASE
        WHEN ch.trade_nm IS NULL THEN NULL
...
CREATE OR REPLACE  VIEW :db_name.fmdb_subm_by_applicant_vw (submission_no, chemical_name, applicant, indication, sub_type, cdr, dateofcdr_recommendation, cdr_recommendation, dbc_date, dbc_recommendation, psd_status, date_review_start, decision_date, review_days, legal_nm, rn) AS
SELECT
    sub.submission_no AS submission_no, CONCAT_WS('', ch.chemical_nm,
    CASE
        WHEN ch.trade_nm IS NULL THEN NULL
...
CREATE OR REPLACE  VIEW :db_name.fmdb_submissions_vw (submission_no, chemical_name, applicant, indication, sub_type, cdr, cdr_recommendation, dbc_date, dbc_recommendation, psd_status, date_review_start, decision_date, review_days) AS
SELECT
    sub.submission_no AS submission_no, CONCAT_WS('', ch.chemical_nm,
    CASE
        WHEN ch.trade_nm IS NULL THEN NULL
...
CREATE OR REPLACE  VIEW :db_name.fmdb_technical_review_vw (submission_no, chemical_name, applicant, indication, sub_type, cdr, reviewer_name, question_sent_date, review_target_date, review_completion_date, review_days, psd_status, requested_yn, rn) AS
SELECT
    sub.submission_no AS submission_no, CONCAT_WS('', ch.chemical_nm,
    CASE
        WHEN ch.trade_nm IS NULL THEN NULL
    ...
    FROM :db_name.fmdb_submission AS sub, :db_name.fmdb_submission_types AS sut, :db_name.fmdb_companies AS co, :db_name.fmdb_chemicals AS ch, :db_name.fmdb_review_statuses AS rs, :db_name.fmdb_submission_review_details AS srd, :db_name.fmdb_reviewer_name_types AS rnt, :db_name.fmdb_review_questions AS rq
...
ON :db_name.fmdb_companies
USING BTREE (company_type_cd ASC);

CREATE INDEX cd_cn_fk_i
ON :db_name.fmdb_contact_details
USING BTREE (contact_name_id ASC);
...
ON :db_name.fmdb_regions
USING BTREE (country_cd ASC);

CREATE INDEX rq_rnt_fk_i
ON :db_name.fmdb_review_questions
...
ON :db_name.fmdb_submission_review_details
...
ALTER TABLE :db_name.fmdb_submission_review_details
...
REFERENCES :db_name.fmdb_address_types (address_type_cd)
ON DELETE NO ACTION;

ALTER TABLE :db_name.fmdb_addresses
ADD CONSTRAINT adr_cn_fk FOREIGN KEY (contact_name_id) 
REFERENCES :db_name.fmdb_contact_names (contact_name_id)
ON DELETE NO ACTION;

ALTER TABLE :db_name.fmdb_addresses
ADD CONSTRAINT adr_com_fk FOREIGN KEY (company_id) 
REFERENCES :db_name.fmdb_companies (company_id)
ON DELETE NO ACTION;

ALTER TABLE :db_name.fmdb_addresses
ADD CONSTRAINT adr_reg_fk FOREIGN KEY (region_cd, country_cd) 
REFERENCES :db_name.fmdb_regions (region_cd, country_cd)
ON DELETE NO ACTION;

ALTER TABLE :db_name.fmdb_chemicals
ADD CONSTRAINT che_sub_fk FOREIGN KEY (submission_id) 
REFERENCES :db_name.fmdb_submission (submission_id)
ON DELETE NO ACTION;

ALTER TABLE :db_name.fmdb_companies
ADD CONSTRAINT com_ct1_fk FOREIGN KEY (company_type_cd) 
REFERENCES :db_name.fmdb_company_types (company_type_cd)
ON DELETE NO ACTION;
...
REFERENCES :db_name.fmdb_contact_types (contact_type_cd)
ON DELETE NO ACTION;

ALTER TABLE :db_name.fmdb_dins
ADD CONSTRAINT din_che_fk FOREIGN KEY (chemical_id) 
REFERENCES :db_name.fmdb_chemicals (chemical_id)
ON DELETE NO ACTION;
...
REFERENCES :db_name.fmdb_product_listing_agreement (pla_id)
ON DELETE NO ACTION;

ALTER TABLE :db_name.fmdb_product_listing_agreement
ADD CONSTRAINT pla_pst_fk FOREIGN KEY (pla_status_cd) 
REFERENCES :db_name.fmdb_pla_status_types (pla_status_cd)
ON DELETE NO ACTION;
...
REFERENCES :db_name.fmdb_countries (country_cd)
ON DELETE NO ACTION;

ALTER TABLE :db_name.fmdb_review_questions
ADD CONSTRAINT rq_rnt_fk FOREIGN KEY (reviewer_name_cd) 
REFERENCES :db_name.fmdb_reviewer_name_types (reviewer_name_cd)
ON DELETE NO ACTION;

ALTER TABLE :db_name.fmdb_review_questions
ADD CONSTRAINT rq_srd_fk FOREIGN KEY (submission_review_id) 
REFERENCES :db_name.fmdb_submission_review_details (submission_review_id)
ON DELETE NO ACTION;
...
REFERENCES :db_name.fmdb_submission_types (submission_type_cd)
ON DELETE NO ACTION;

ALTER TABLE :db_name.fmdb_submission_review_details
ADD CONSTRAINT srd_brc_fk FOREIGN KEY (bia_requsted_cd) 
REFERENCES :db_name.fmdb_bia_requested_codes (bia_requsted_cd)
ON DELETE NO ACTION;

ALTER TABLE :db_name.fmdb_submission_review_details
ADD CONSTRAINT srd_rs_fk FOREIGN KEY (review_status_cd) 
REFERENCES :db_name.fmdb_review_statuses (review_status_cd)
ON DELETE NO ACTION;
...
CREATE OR REPLACE FUNCTION :db_name.fmdb_microstrategy$businessdaysbetween(IN enddate TIMESTAMP WITHOUT TIME ZONE, IN startdate TIMESTAMP WITHOUT TIME ZONE)
...
CREATE OR REPLACE FUNCTION :db_name.person_pwn_pk_trg$person_pwn()
RETURNS trigger
AS
$BODY$
BEGIN
    SELECT
        nextval(':db_name.person_pwn_pk_seq')
        INTO STRICT new.id;
    RETURN NEW;
END;
$BODY$
...
FOR EACH ROW
WHEN (new.id IS NULL)
EXECUTE PROCEDURE :db_name.person_pwn_pk_trg$person_pwn();
